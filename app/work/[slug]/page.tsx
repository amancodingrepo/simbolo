...
export default async function WorkSingle({
  params,
}: {
            ...
            <div className="col-md-8 md-mb-24">
              ...
              <div className="list-tags effectFade fadeUp">
                {project.deliverables.map((d, i) => (
                  <a key={i} href="#" className="tags-item fw-semibold">
                    {d}
                  </a>
                ))}
              </div>
                    ...
                    <div className="grid-text">
                      ...
                      <div className="item">
                        ...
                        <div className="fw-semibold text-body-3">
                          {next.deliverables.slice(0, 2).join(", ")}
                        </div>
                      </div>
                      <div className="item">
