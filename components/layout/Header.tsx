...
export default function Header() {
  return (
    <header className="tf-header header2">
      <div className="header-inner" style={{ maxWidth: '1100px', padding: '12px 12px 12px 40px' }}>
        <Link href="/" className="logo-site">
          <img src="/assets/aman/logo.png" alt="" style={{ height: '44px', width: 'auto' }} />
        </Link>
        <div className="box-navigation">
          <ul className="nav-menu-main">
            <li className="menu-item">
              <Link href="/" className="item-link link1 active">Home</Link>
            </li>
            <li className="menu-item">
            ...
            <li className="menu-item">
              <Link href="/blog/three-columns" className="item-link link1">Blog</Link>
            </li>
            <li className="menu-item">
