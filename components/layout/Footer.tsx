      ...
      <div className="container">
          ...
          <Link href="/" className="footer-logo">
            <div className="footer-logo-badge">
              <img
                ...
                alt="Logo"
                className="footer-logo-badge-img"
              />
            </div>
          </Link>
          <div className="title h6 fw-semibold">
            Scale <br /> with Simbolo on social
          </div>
          <div className="text">
            Get the latest growth strategies and visual trends!
          </div>
        ...
        <div className="footer-bottom">
          <ul className="footer-links d-flex gap-24 align-items-center">
            <li>
              <Link href="/about" className="fw-semibold link-underline link1">
                About
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/work" className="fw-semibold link-underline link1">
                Works
              </Link>
            </li>
            <li>
