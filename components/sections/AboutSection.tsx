...
export default function AboutSection({
  ...
  const resolvedTitle =
    heading ?? headingTitle ?? "Creative Excellence Meets Measurable ROI";

  // Resolve testimonial: support both object and flat props
  const resolvedTestimonial: TestimonialProps = testimonial ?? {
    quote:
      testimonialText ??
      "Great marketing isn't just seen; it's felt—and then it converts.",
  ...
  return (
    <div
      className="section-about-us flat-spacing"
      id={sectionId}
            ...
            <div className="col-left">
              <div className="position-relative z-5">
                ...
                <h5 className="title fw-semibold text-white">
                  Based in <span className="text-brand">Indore</span>, India
                </h5>
          ...
          <div className="col-xxl-5 col-lg-6">
              ...
              <div className="d-flex justify-content-between flex-wrap align-items-end gap-12">
                ...
                <div className="counter text-neutral-200">
                  <span
                    ...
                    data-inviewport={
                      clientCounterProps.inViewport ? "yes" : "no"
                    }
                  >
                    {clientCount}
                  </span>
            ...
            <div className="box-quotes effectFade fadeRotateX">
              <div className="content">
                ...
                <div
                  className="fw-semibold desc"
                  style={{ fontSize: "1.35rem", lineHeight: "1.5" }}
                >
                  {resolvedTestimonial.quote}
                </div>
                <div className="cite">
                  <div className="name text-body-3 fw-semibold">
                    {resolvedTestimonial.name}
                  </div>
                  <div className="line"></div>
                  <div className="sub text-body-3">
                    {resolvedTestimonial.role}
                  </div>
                </div>
              </div>
            </div>
